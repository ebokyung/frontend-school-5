class VendingMachineEvents {
    constructor() {
        const vMachine = document.querySelector('.section-a');
        this.balance = vMachine.querySelector('.checkout .info strong');
        this.itemList = vMachine.querySelector('.sale-items');
        ...
        this.stagedList = vMachine.querySelector('.vm-item-ul');


        const myinfo = document.querySelector('.section-b');
        this.myMoney = myinfo.querySelector('.info strong');

        const getInfo = document.querySelector('.section-c');
        this.getList = getInfo.querySelector('.vm-item-ul');
    ...
    stagedItemGenerator(target) {
        ...
        stagedItem.classList.add('vm-item-li')

        stagedItem.innerHTML = `
            <img class="img" src="./img/${target.dataset.img}" alt="">
            <p class="name">${target.dataset.item}</p>
            <strong class="count"><span>1</span><span class="a11y-hidden">개</span></strong>
        `;
    ...
    bindEvent() {
         ...
         */
        this.btnsCola = document.querySelectorAll('.section-a .vm-item');
